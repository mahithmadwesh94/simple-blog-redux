                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12 col-sm-12 col-md-12 col-lg-12">
                                <h1 className="intro-heading text-start">Learning React Library</h1>
                            </div>
                            <div>
                                ...
                                <div className='row'>
                                    ...
                                    <div className="col-12 col-sm-12 col-md-12 col-lg-4 m-2" >
                                        <div className="card router-card" >
                                            <div className="tech-intro ">
                                                <SiReactrouter className="tech-logo" /> <div className="tech-info align-middle"> react-router-dom </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-12 col-sm-12 col-md-12 col-lg-4 m-2" >
                                        <div className="card icon-card" >
                                            <div className="tech-intro ">
                                                <RiReactjsLine className="tech-logo react-icons-logo" /> <div className="tech-info align-middle"> react-icons </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
